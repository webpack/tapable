...
interface HookMap {
	for: (key: any) => Hook,
	tap: (key: any, name: string, fn: (...args) => Result) => void,
	tapAsync: (key: any, name: string, fn: (...args, callback: (err, result: Result) => void) => void) => void,
	tapPromise: (key: any, name: string, fn: (...args) => Promise<Result>) => void,
