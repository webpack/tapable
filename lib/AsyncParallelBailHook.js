...
class AsyncParallelBailHookCodeFactory extends HookCodeFactory {
	...
	content({ onError, onResult, onDone }) {
		...
		code += /** @type {(result: string) => string} */ (onResult)("item.result");
		code += "return true;\n";
		code += "}\n";
		code += "if(item.error) {\n";
		code += /** @type {(err: string) => string} */ (onError)("item.error");
		code += "return true;\n";
		code += "}\n";
		code += "}\n";
		code += "return false;\n";
 ...
 * @returns {Hook<EXPECTED_ANY, EXPECTED_ANY, EXPECTED_ANY>} a new AsyncParallelBailHook instance
 */
